...
cat $MDIR/bin/reinstall/tpl/php/php56/reentrancy.c > $MDIR/source/php/php55/main/reentrancy.c
cat $MDIR/bin/reinstall/tpl/php/php56/ext/pcre/sljitConfigInternal.h > $MDIR/source/php/php55/ext/pcre/pcrelib/sljit/sljitConfigInternal.h
